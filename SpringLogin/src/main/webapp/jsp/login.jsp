...
<link rel="stylesheet" href="criss.css">
		...
		<div class="row mx-auto">
			...
			<div class="col-lg-6 my-auto">
				<form class="form-control"
					action="http://localhost:8080/LoginServlet/loginServlet"
					method="post">
					<img src="woman.jfif" class="rounded mx-auto d-block" />
					<div class="form-group">
						<label for="email" class="col-sm-2">Email:</label> <input
							type="email" class="form-control" id="email"
							placeholder="Enter email" name="email" />
					</div>
					<div class="form-group">
						<label for="pwd" class="col-sm-2">Password:</label> <input
